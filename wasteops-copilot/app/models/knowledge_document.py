...
class KnowledgeDocument(Base):
    ...
    is_synthetic: Mapped[bool | None] = mapped_column(Boolean, nullable=True, index=True)
    authority_level: Mapped[str] = mapped_column(String(30), default="unknown", nullable=False, index=True)
