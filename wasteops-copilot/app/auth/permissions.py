...
ROLE_PERMISSIONS: dict[Role, frozenset[Permission]] = {
    ...
    Role.OPERATOR: frozenset({P.DASHBOARD_READ, P.ANALYTICS_READ, P.DOCUMENTS_READ, P.ASSISTANT_USE, P.FEEDBACK_CREATE, P.OPTIMIZATION_REQUEST}),
    Role.MANAGER: frozenset(
        {
            ...
            P.DECISIONS_REQUEST,
            P.DECISIONS_PREVIEW,
            P.OPTIMIZATION_REQUEST,
            P.OPTIMIZATION_APPROVE,
        }
    ),
