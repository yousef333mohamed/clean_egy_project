...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("critical_failures", sa.Integer(), server_default="0", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("expected_json", postgresql.JSONB(), server_default=sa.text("'{}'::jsonb"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("prompt_key", sa.String(80)),
